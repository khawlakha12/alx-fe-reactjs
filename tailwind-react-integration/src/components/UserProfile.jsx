...
function UserProfile() {
  return (
    <div className="user-profile bg-gray-100 p-4 sm:p-4 md:p-8 max-w-xs sm:max-w-xs md:max-w-sm mx-auto my-10 rounded-lg shadow-lg hover:shadow-xl" >
      ...
      <p className=" text-gray-600 text-sm sm:text-sm md:text-base text-center hover:text-blue-500">
